...
const AdminProducts = ({item}) => {
    ...
    const deleteProduct = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`http://localhost:4000/api/products/${item._id}/delete`, {
                    method: "DELETE",
                    headers: {
    ...
    const archiveProduct = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`http://localhost:4000/api/products/${item._id}/archive`, {
                    method: "PUT",
                    headers: {
                        "Authorization": `Bearer ${token}`,
                        "Content-Type": "application/json"
    ...
    const unarchiveProduct = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`http://localhost:4000/api/products/${item._id}/unarchive`, {
                    method: "PUT",
                    headers: {
                        "Authorization": `Bearer ${token}`,
                        "Content-Type": "application/json"
    ...
    const editProduct = () => {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`http://localhost:4000/api/products/${item._id}`, {
                        method: "PUT",
                        headers: {
                            "Authorization": `Bearer ${token}`,
                            "Content-Type": "application/json"
